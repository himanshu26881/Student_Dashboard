...
function addDemoData() {
    ...
    const addStudents = [
        ...
        { id: '4', name: 'Puja Jana', rollNo: '34', class: 'BCA', attendance: 30 },
    ];
    ...
    const addLibraryRecords = [
        ...
        { id: '4', studentId: '4', studentName: 'Puja Jana', studentRollNo: '52', bookTitle: 'Machine Learning Guide', status: 'Issued', date: '2025-10-04' }
    ];
